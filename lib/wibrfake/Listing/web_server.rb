module WibrFake
    class Listing
        def self.web_server_show(configAP)
            puts "Set options for the server:"
            puts
            ...
            puts "  route" + " " * 9 + configAP.login_route.to_s.ljust(26) + "yes".ljust(3) +  " " * 12 + "Web Server Page Path"
            ...
            puts "  credentials" + " " * 3 + configAP.path_credential.to_s.ljust(26) + "no".ljust(3) +  " " * 12 + "Path where credentials will be saved"
            puts "-" * 70
